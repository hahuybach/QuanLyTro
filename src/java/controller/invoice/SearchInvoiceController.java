 ...
 * @author Bach
 */
public class SearchInvoiceController extends BaseAuthController {
    ...
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../view/invoice/searchInvoice.jsp").forward(request, response);
    }
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Invoice invoice = db.getInvoice(month, year, roomID);
